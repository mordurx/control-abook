...
//         $email_message.="su usuario es : ".$username."\n";
         $email_message="Bienvenidos a nuestra plataforma de lectura asistida.\n\nEsta plataforma está diseñada para acompañar a lector en su proceso de lectura, poniendo especial énfasis en el desarrollo de habilidades meta cognitivas necesarias 
para una comprensión eficiente. Los cuentos seleccionados en esta plataforma son cuentos recomendados por el Consejo Nacional de la  Cultura y las Artes, y contienen
una variedad de temas adecuados para todas las edades.
En lo práctico, nuestra plataforma divide los cuentos en pequeños fragmentos, el cual es siempre seguido de una pregunta. Cada pregunta está diseñada para potenciar
habilidades específicas relevantes para la comprensión del lenguaje escrito. Luego de responder cada pregunta, el lector recibirá retroalimentación orientado nuevamente
a fortalecer habilidades específicas, pero además motivándolos a continuar con su proceso de lectura.
Estamos convencidos que esta plataforma ayudará a los lectores a fortalecer sus habilidades comprensivas y le agradecemos por su participación.\n\n";

        $email_message.="su usuario es : ".$username."\n";


        //include("PHPMailer/class.smtp.php"); // optional, gets called from within class.phpmailer.php if not already loaded
        $email_from="abookteam@a-book.atwebpages.com";
        $email_to = $email;
        $email_subject = "Bienvenidos a nuestra plataforma";
